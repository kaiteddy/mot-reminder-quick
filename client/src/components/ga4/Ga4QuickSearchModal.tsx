...
import { DOC_TYPE_HEX, DOC_TYPE_TINT, groupByDocType } from "@/lib/docType";
          ...
          {documents.length > 0 && (
            <>
              ...
              {groupByDocType(documents).map((tg) => (
                <div key={tg.type}>
                  <div className="qs-subsection-head" style={{ background: DOC_TYPE_TINT[tg.type] || undefined, color: DOC_TYPE_HEX[tg.type] || undefined, borderLeft: `4px solid ${DOC_TYPE_HEX[tg.type] || "#999"}` }}>{tg.label}</div>

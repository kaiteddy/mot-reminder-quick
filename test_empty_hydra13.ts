...
async function run() {
    ...
    console.log("res.products IS TYPE:", typeof res.products);
    console.log("res.products IS ARRAY?", Array.isArray(res.products));
    console.log("Keys of res.products:", Object.keys(res.products || {}));
    if (Object.keys(res.products || {}).length > 0) {
        console.log("FIRST KEY VALUE:", res.products[Object.keys(res.products)[0]]);
    }
}

...
import { gsfRouter } from "./routers/gsf";
    ...
    lookupMOT: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        return {
          ...
          colour: motData?.primaryColour || dvlaData?.colour || ukvdData?.colour,
          fuelType: motData?.fuelType || dvlaData?.fuelType || ukvdData?.fuelType,
          taxStatus: dvlaData?.taxStatus,
          taxDueDate: dvlaData?.taxDueDate,
          motTests: motData?.motTests || [],
          // All DVLA fields
          engineCapacity: dvlaData?.engineCapacity || ukvdData?.engineSize,
          co2Emissions: dvlaData?.co2Emissions || ukvdData?.co2Emissions,
          ...
          euroStatus: dvlaData?.euroStatus || ukvdData?.euroStatus,
          ...
          imageUrl: ukvdData?.imageUrl,
          dimensions: ukvdData?.dimensions,
          weights: ukvdData?.weights,
          fuelTankCapacity: ukvdData?.fuelTankCapacity,
          transmission: ukvdData?.transmission,
        };
      }),

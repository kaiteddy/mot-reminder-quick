...
export function mapGA4Document(row: GA4Document) {
  ...
  return {
    ...
    // Sales-Summary breakdown fields (Fixed Item 1/2/3 = Sundries / Lubricants / Paint & Mat.)
    fixedItem1Net: parseGA4Money(pick(row, "fixedR_Item1NET", "us_FixedItem1NET", "Fixed Item 1 Net")),
    fixedItem1Tax: parseGA4Money(pick(row, "fixedR_Item1Tax", "us_FixedItem1TAX", "Fixed Item 1 Tax")),
    fixedItem1Gross: parseGA4Money(pick(row, "fixedR_Item1Gross", "us_FixedItem1GROSS", "Fixed Item 1 Gross")),
    fixedItem2Net: parseGA4Money(pick(row, "fixedR_Item2NET", "us_FixedItem2NET", "Fixed Item 2 Net")),
    fixedItem2Tax: parseGA4Money(pick(row, "fixedR_Item2Tax", "us_FixedItem2TAX", "Fixed Item 2 Tax")),
    fixedItem2Gross: parseGA4Money(pick(row, "fixedR_Item2Gross", "us_FixedItem2GROSS", "Fixed Item 2 Gross")),
    fixedItem3Net: parseGA4Money(pick(row, "fixedR_Item3NET", "us_FixedItem3NET", "Fixed Item 3 Net")),
    fixedItem3Tax: parseGA4Money(pick(row, "fixedR_Item3Tax", "us_FixedItem3TAX", "Fixed Item 3 Tax")),
    fixedItem3Gross: parseGA4Money(pick(row, "fixedR_Item3Gross", "us_FixedItem3GROSS", "Fixed Item 3 Gross")),
    subPartsCostNet: parseGA4Money(pick(row, "us_SubTotal_PartsCostNET", "Sub Parts Cost Net")),
    subPartsCostTax: parseGA4Money(pick(row, "us_SubTotal_PartsCostTAX", "Sub Parts Cost Tax")),
    subPartsCostGross: parseGA4Money(pick(row, "us_SubTotal_PartsCostGROSS", "Sub Parts Cost Gross")),
    labourQty: parseGA4Money(pick(row, "us_SubTotal_LabourQTY", "Labour Qty")),
    totalSurcharge: parseGA4Money(pick(row, "us_TotalSurcharge", "Total Surcharge")),
    totalDiscountNet: parseGA4Money(pick(row, "us_TotalDiscount_NET", "Total Discount Net")),
    totalDiscountGross: parseGA4Money(pick(row, "us_TotalDiscount_GROSS", "Total Discount Gross")),
    motQty: (() => { const v = pick(row, "motQty", "MOT Qty"); return v ? parseInt(v, 10) || null : null; })(),
    motCost: parseGA4Money(pick(row, "motCost", "MOT Cost")),
    motOutsourced: pick(row, "motOutsourced", "MOT Outsourced"),

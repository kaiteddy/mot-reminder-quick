...
export function mapGA4Document(row: GA4Document) {
  ...
  return {
    ...
    fixedItem1Net: parseGA4Money(pick(row, "us_FixedItem1NET", "Fixed Item 1 Net")),
    fixedItem1Tax: parseGA4Money(pick(row, "us_FixedItem1TAX", "Fixed Item 1 Tax")),
    fixedItem1Gross: parseGA4Money(pick(row, "us_FixedItem1GROSS", "Fixed Item 1 Gross")),
    fixedItem2Net: parseGA4Money(pick(row, "us_FixedItem2NET", "Fixed Item 2 Net")),
    fixedItem2Tax: parseGA4Money(pick(row, "us_FixedItem2TAX", "Fixed Item 2 Tax")),
    fixedItem2Gross: parseGA4Money(pick(row, "us_FixedItem2GROSS", "Fixed Item 2 Gross")),
    fixedItem3Net: parseGA4Money(pick(row, "us_FixedItem3NET", "Fixed Item 3 Net")),
    fixedItem3Tax: parseGA4Money(pick(row, "us_FixedItem3TAX", "Fixed Item 3 Tax")),
    fixedItem3Gross: parseGA4Money(pick(row, "us_FixedItem3GROSS", "Fixed Item 3 Gross")),

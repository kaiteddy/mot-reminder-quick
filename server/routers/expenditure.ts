...
export const expenditureRouter = router({
  ...
  expenditureBreakdown: adminProcedure
  ...
  reclassifyPayee: adminProcedure
  ...
  setTxnVatOverride: adminProcedure
  ...
  setOverrideBulk: adminProcedure
  ...
  // ── Car trading ledger ──
  carDeals: adminProcedure.query(async () => {
    const { getCarDeals } = await import("../services/expenditure");
    return getCarDeals();
  }),

  upsertCarDeal: adminProcedure
    .input(z.object({

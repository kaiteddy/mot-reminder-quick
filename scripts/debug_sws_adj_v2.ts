...
async function testCapacities() {
    ...
    // 'ADJUSTMENTS' often contains capacities in HaynesPro/SWS systems
    const subjects = ['ADJUSTMENTS', 'TECHNICAL_DATA', 'CAPACITIES', 'FILL_CAPACITIES', 'FLUID_CAPACITIES'];
